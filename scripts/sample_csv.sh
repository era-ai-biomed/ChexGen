...
set -euo pipefail
#############################################################
# Sample chest X-rays from a CSV prompt file.
#
# Usage:
#   bash scripts/sample_csv.sh                       # default: data/mimic_val_p19_impression_example.csv
#   bash scripts/sample_csv.sh path/to/prompts.csv   # custom CSV
#############################################################
...
PROMPT_FILE="${1:-data/mimic_val_p19_impression_example.csv}"
