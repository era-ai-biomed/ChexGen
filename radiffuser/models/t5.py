...
class T5Embedder:
    ...
    def __init__(self, device, dir_or_name='t5-v1_1-xxl', *, local_cache=False, cache_dir=None, hf_token=None, use_text_preprocessing=True,
        ...
        if local_cache:
            ...
            snapshot_download(repo_id="DeepFloyd/t5-v1_1-xxl", local_dir=cache_dir)
            # for filename in [
            ...
            # ]:
            #     # huggingface-cli download --repo-id DeepFloyd/t5-v1_1-xxl --local-dir /scratch/m000071/yfj/weights/t5
